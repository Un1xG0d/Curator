...
static PyObject *meth_FbxPropertyEType_Get(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_FbxPropertyEType, &sipCpp))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_FbxLight_EType);
        }
    }
...
extern "C" {static void assign_FbxPropertyEType(void *, SIP_SSIZE_T, const void *);}
static void assign_FbxPropertyEType(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::FbxPropertyEType *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::FbxPropertyEType *>(sipSrc);
}


extern "C" {static void *array_FbxPropertyEType(SIP_SSIZE_T);}
static void *array_FbxPropertyEType(SIP_SSIZE_T sipNrElem)
{
    return new  ::FbxPropertyEType[sipNrElem];
}


extern "C" {static void *copy_FbxPropertyEType(const void *, SIP_SSIZE_T);}
static void *copy_FbxPropertyEType(const void *sipSrc, SIP_SSIZE_T sipSrcIdx)
{
...
static void *init_type_FbxPropertyEType(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_FbxPropertyEType, &a0))
        {
            sipCpp = new  ::FbxPropertyEType(*a0);
...
static PyMethodDef methods_FbxPropertyEType[] = {
    {SIP_MLNAME_CAST(sipName_Get), meth_FbxPropertyEType_Get, METH_VARARGS, SIP_MLDOC_CAST(doc_FbxPropertyEType_Get)}
};
