...
extern "C" {static void assign_FbxPropertyBool1(void *, SIP_SSIZE_T, const void *);}
static void assign_FbxPropertyBool1(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::FbxPropertyBool1 *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::FbxPropertyBool1 *>(sipSrc);
}


extern "C" {static void *array_FbxPropertyBool1(SIP_SSIZE_T);}
static void *array_FbxPropertyBool1(SIP_SSIZE_T sipNrElem)
{
    return new  ::FbxPropertyBool1[sipNrElem];
}


extern "C" {static void *copy_FbxPropertyBool1(const void *, SIP_SSIZE_T);}
static void *copy_FbxPropertyBool1(const void *sipSrc, SIP_SSIZE_T sipSrcIdx)
{
...
static void *init_type_FbxPropertyBool1(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_FbxPropertyBool1, &a0))
        {
            sipCpp = new  ::FbxPropertyBool1(*a0);
...
static PyMethodDef methods_FbxPropertyBool1[] = {
    {SIP_MLNAME_CAST(sipName_Get), meth_FbxPropertyBool1_Get, METH_VARARGS, SIP_MLDOC_CAST(doc_FbxPropertyBool1_Get)}
};
