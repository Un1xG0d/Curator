...
extern "C" {static void assign_FbxPropertyFbxMediaClipEAccessMode(void *, SIP_SSIZE_T, const void *);}
static void assign_FbxPropertyFbxMediaClipEAccessMode(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::FbxPropertyFbxMediaClipEAccessMode *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::FbxPropertyFbxMediaClipEAccessMode *>(sipSrc);
}


extern "C" {static void *array_FbxPropertyFbxMediaClipEAccessMode(SIP_SSIZE_T);}
static void *array_FbxPropertyFbxMediaClipEAccessMode(SIP_SSIZE_T sipNrElem)
{
    return new  ::FbxPropertyFbxMediaClipEAccessMode[sipNrElem];
}


extern "C" {static void *copy_FbxPropertyFbxMediaClipEAccessMode(const void *, SIP_SSIZE_T);}
static void *copy_FbxPropertyFbxMediaClipEAccessMode(const void *sipSrc, SIP_SSIZE_T sipSrcIdx)
{
...
{
     ::FbxPropertyFbxMediaClipEAccessMode *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_FbxPropertyFbxMediaClipEAccessMode, &a0))
        {
            sipCpp = new  ::FbxPropertyFbxMediaClipEAccessMode(*a0);
...
static PyMethodDef methods_FbxPropertyFbxMediaClipEAccessMode[] = {
    {SIP_MLNAME_CAST(sipName_Get), meth_FbxPropertyFbxMediaClipEAccessMode_Get, METH_VARARGS, SIP_MLDOC_CAST(doc_FbxPropertyFbxMediaClipEAccessMode_Get)}
};
