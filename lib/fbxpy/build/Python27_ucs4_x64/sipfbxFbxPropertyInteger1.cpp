...
extern "C" {static void assign_FbxPropertyInteger1(void *, SIP_SSIZE_T, const void *);}
static void assign_FbxPropertyInteger1(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::FbxPropertyInteger1 *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::FbxPropertyInteger1 *>(sipSrc);
}


extern "C" {static void *array_FbxPropertyInteger1(SIP_SSIZE_T);}
static void *array_FbxPropertyInteger1(SIP_SSIZE_T sipNrElem)
{
    return new  ::FbxPropertyInteger1[sipNrElem];
}


extern "C" {static void *copy_FbxPropertyInteger1(const void *, SIP_SSIZE_T);}
static void *copy_FbxPropertyInteger1(const void *sipSrc, SIP_SSIZE_T sipSrcIdx)
{
...
static void *init_type_FbxPropertyInteger1(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_FbxPropertyInteger1, &a0))
        {
            sipCpp = new  ::FbxPropertyInteger1(*a0);
...
static PyMethodDef methods_FbxPropertyInteger1[] = {
    {SIP_MLNAME_CAST(sipName_Get), meth_FbxPropertyInteger1_Get, METH_VARARGS, SIP_MLDOC_CAST(doc_FbxPropertyInteger1_Get)}
};
